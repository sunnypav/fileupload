require("gsap");
var $gXNCa$qrcode = require("qrcode");
...
class $fcde0f254d850342$export$6f290de2114a78e9 {
...
class $5efd2ab1b7a94a4c$export$5f1af8db9871e1d6 extends (0, $fcde0f254d850342$export$6f290de2114a78e9) {
...
class $8f534251f6d90314$export$3e431a229df88919 extends (0, $fcde0f254d850342$export$6f290de2114a78e9) {
    constructor(data, element, vpaidSettings){
        super(data, element, vpaidSettings);
    }
    createElement() {
...
class $d94e07f2660523b6$export$ae01dedf5c052bb extends (0, $fcde0f254d850342$export$6f290de2114a78e9) {
    constructor(data, element, vpaidSettings){
        super(data, element, vpaidSettings);
    }
    createElement() {
...
class $4ace0d4aae2b8a4a$export$7a8899e6b0e671b3 extends (0, $fcde0f254d850342$export$6f290de2114a78e9) {
    constructor(data, element, vpaidSettings){
        super(data, element, vpaidSettings);
        this.generateQRCode();
        this.markLoaded();
    ...
    generateQRCode() {
        this.qrCodeInstance = new (0, ($parcel$interopDefault($gXNCa$qrcode)))(this.domElement, {
...
class $7d28725e793fae12$export$c57e9b2d8b9e4de extends (0, $fcde0f254d850342$export$6f290de2114a78e9) {
    constructor(data, element1, vpaidSettings){
...
class $668a9dc2947823ed$export$a5e9477317b8a615 {
    static createElement(data, element, vpaidSettings) {
        switch(data.type){
            case "text":
                return new (0, $5efd2ab1b7a94a4c$export$5f1af8db9871e1d6)(data, element, vpaidSettings);
            case "image":
                return new (0, $8f534251f6d90314$export$3e431a229df88919)(data, element, vpaidSettings);
            case "video":
                return new (0, $d94e07f2660523b6$export$ae01dedf5c052bb)(data, element, vpaidSettings);
            case "qr":
                return new (0, $4ace0d4aae2b8a4a$export$7a8899e6b0e671b3)(data, element, vpaidSettings);
            case "timer":
                return new (0, $7d28725e793fae12$export$c57e9b2d8b9e4de)(data, element, vpaidSettings);
            default:
                return null;
        }
    }
...
class $8a31f8df4241fe52$var$VPaidAd {
    constructor(){
    ...
    prebuildElements() {
        ...
        this.elements.forEach((parallel)=>{
            parallel.elements.forEach((el)=>{
                const elementInstance = (0, $668a9dc2947823ed$export$a5e9477317b8a615).createElement(this.adParameters, el, this.vpaidSettings);
                if (elementInstance) {
...
var $8a31f8df4241fe52$export$2e2bcd8739ae039 = $8a31f8df4241fe52$var$VPaidAd;


window.getVPAIDAd = function() {
    return new (0, $8a31f8df4241fe52$export$2e2bcd8739ae039)();
};
